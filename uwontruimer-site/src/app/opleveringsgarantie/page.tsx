    ...
    <>
      ...
      <main className="mt-16">
        <div className="relative w-full overflow-hidden" style={{ height: "400px" }}>
          <Image src="/hero-handdruk-oplevering.jpg" alt="Tevreden klant schudt de hand na een geslaagde oplevering door Uw Ontruimer" fill className="w-full h-full object-cover" style={{ objectPosition: "center 60%" }} priority />
