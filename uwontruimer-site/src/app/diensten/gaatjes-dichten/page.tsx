    ...
    <>
      ...
      <main className="mt-16">
        <div className="relative w-full overflow-hidden" style={{ height: "400px" }}>
          <Image src="/hero-verhuisdozen-bus.jpg" alt="Gaatjes dichten na ontruiming" fill className="w-full h-full object-cover" style={{ objectPosition: "center center" }} priority />
