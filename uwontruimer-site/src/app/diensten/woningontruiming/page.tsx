    ...
    <>
      ...
      <main className="mt-16">
        ...
        <div className="relative w-full overflow-hidden" style={{ height: '400px' }}>
          <Image src="/truck-woningontruiming.png" alt="Professionele woningontruiming" fill className="w-full h-full object-cover" style={{ objectPosition: "center center" }} priority />
