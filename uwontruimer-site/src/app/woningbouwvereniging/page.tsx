      ...
      <main className="mt-16">
        <div className="bg-white py-20 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-slate-500 font-light leading-relaxed mb-6">UwOntruimer werkt als vaste partner voor woningcorporaties bij huisuitzettingen, woningwisselingen en opleveringen. Wij begrijpen de tijdsdruk die bij corporatievastgoed hoort en zorgen voor snelle doorlooptijden.</p>
