      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-64px)]">
        ...
        <div className="relative flex flex-col justify-center px-8 lg:px-16 py-16 lg:bg-white min-h-[520px] lg:min-h-0">
          ...
          <div className="relative z-10 lg:hidden -mx-8 -mt-16 mb-10 h-64 overflow-hidden">
            <Image src="/hero-handdruk-oplevering.jpg" alt="Medewerker van Uw Ontruimer schudt de hand van een tevreden klant in een leeg opgeleverde woning" fill sizes="(min-width: 1024px) 0px, 100vw" className="object-cover object-[65%_45%]" priority fetchPriority="high" />
          </div>
          {/* Content */}
        ...
        <div className="hidden lg:block relative overflow-hidden">
          <Image src="/hero-handdruk-oplevering.jpg" alt="Medewerker van Uw Ontruimer schudt de hand van een tevreden klant in een leeg opgeleverde woning" fill sizes="(max-width: 1023px) 0px, 50vw" className="object-cover object-center" priority fetchPriority="high" />
