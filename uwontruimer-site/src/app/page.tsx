    ...
    <>
      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-64px)]">
        ...
        <div className="relative overflow-hidden min-h-[400px] lg:min-h-0">
          <Image src="/enhanced_uw-ontruimer-0414_075042732_iOS 1.png" alt="Professionele woningontruiming door UwOntruimer" fill className="object-cover object-center" priority quality={90} />
