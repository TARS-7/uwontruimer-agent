...
// Microsoft Clarity (heatmaps + sessie-opnames) — zelfde project als de marketingsite
// (x8dmz48ub7), zodat www + wizard in één Clarity-dashboard staan (filter op paginapad).
// Consent-gated: laadt het clarity.ms-tag pas na analytics-consent.
...
/** Analytics-consent uit de vanilla-cookieconsent cookie (cross-domain .uwontruimer.nl). */
